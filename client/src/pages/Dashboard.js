...
const Dashboard = () => {
    ...
    const getSeatColor = (seat) => {
        ...
        if (isBooked) return 'bg-red-400';
        if (seat === seatNumber) return 'bg-blue-400';
        return 'bg-green-300';
    };
    ...
    return (
        <div className="dashboard-container bg-cyan-50 bg-transparent text-gray-100 min-h-screen p-1">
             <header className="dashboard-header flex items-center justify-between mb-6">
                ...
                <nav className="flex space-x-4">
                    <a 
                        href="/Dashboard" 
                        className={`px-4 py-2 rounded transition-colors duration-200 ${window.location.pathname === '/Dashboard' ? 'bg-slate-600 text-white' : 'hover:bg-blue-400 hover:text-white'}`}
                    >
                        Book a Seat
                    </a>
                    <a 
            ...
            <div className="dashboard-content bg-transparent p-6 rounded-lg shadow-lg">
                <div className="seat-selection bg-transparent-20">
